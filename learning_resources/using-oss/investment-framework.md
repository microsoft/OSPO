...
For many metrics, data sources and tooling exists, including using CHAOSS tools like [8Knot](https://eightknot.osci.io/chaoss), [GitHub dependency graph](https://docs.github.com/en/code-security/supply-chain-security/understanding-your-software-supply-chain/about-the-dependency-graph) and ecosystem.ms. At Microsoft we regularly ingest GitHub data about our dependencies, which makes querying a little easier at scale. We're actively working to get better at visualizing that risk for users and will try to share depth of dependencies - more on that soon.  Please consider [this resource to learn more about how we look at risk in our dependencies for investment](https://github.com/microsoft/OSPO/blob/main/bulk-targeted-sponsorship/README.md).
